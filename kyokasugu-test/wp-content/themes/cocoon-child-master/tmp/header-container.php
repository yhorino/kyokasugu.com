...
<link rel="stylesheet" href="/kyokasugu-test/wp-content/themes/cocoon-child-master/tmp/header.css" type="text/css">
...
<header id="common_header">
 <div id="ch_header" class="ch_outer kyokasugu <?php echo $option_class;?>">
  <div class="ch_logo">
   <a href="/">
	   <div class="ch_logo_button_pc"><img src="/kyokasugu-test/wp-content/uploads/2023/12/logo_kyoka.png" alt="建設業許可すぐ取りたい"></div>
	   <div class="ch_logo_button_sp"><img src="/kyokasugu-test/wp-content/uploads/2023/12/logo_kyoka.png" alt="建設業許可すぐ取りたい"></div>
   </a>
  </div>
  ...
  <div class="ch_tel">
   <a href="tel:0120968631">
    <div class="ch_tel_button_pc"><img src="/kyokasugu-test/wp-content/uploads/2023/12/top_tel_kyoka_s.png" alt="0120968631"></div>
...
<?php 
 if($sidemenu_mode == 'mypage'){
  include '/home/rjc/domains/kyokasugu.com/public_html/kyokasugu-test/wp-content/themes/cocoon-child-master/tmp/sidemenu_mypage.php';
 } else {
//  include get_stylesheet_directory().'/tmp/sidemenu.php';
  include '/home/rjc/domains/kyokasugu.com/public_html/kyokasugu-test/wp-content/themes/cocoon-child-master/tmp/sidemenu.php';
 }
?>
